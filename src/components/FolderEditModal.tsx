...
interface FolderEditModalProps {
  visible: boolean;
  folder: Folder | null; // null = creating a new folder, otherwise renaming this one
  allFolders: Folder[];
  onDismiss: () => void;
  onSubmit: (name: string, icon: FolderIconName) => void;
}
    ...
    <Modal visible={visible} transparent animationType="fade">
      <Pressable style={styles.overlay} onPress={onDismiss}>
        <Pressable style={styles.modalContent} onPress={() => {}}>
          <Text style={styles.title}>{folder ? t('folders.rename') : t('folders.createNew')}</Text>
          ...
          <View style={styles.buttonRow}>
            ...
            <Pressable style={styles.submitBtn} onPress={handleSubmit}>
              <Text style={styles.submitText}>{folder ? t('common.save') : t('common.create')}</Text>
            </Pressable>
          </View>
        </Pressable>
      </Pressable>
