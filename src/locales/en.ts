export const en = {
  ...
  onboarding: {
    ...
    sessionSetup: {
      readyTitle: 'Ready to set up your first session, %{name}?',
  ...
  edit: {
    ...
    nameModalTitle: 'Name your session',
    nameModalContinue: 'Continue',
    preview: 'PREVIEW',
    ...
    cooldownAuto:     'AUTO',
    cooldownTaperLabel: 'Cooldown taper',
    cooldownTaperHint:  'Ease speed & incline down through the cooldown, from the phase before it',
