export const en = {
  ...
  sessions: {
    ...
    addTipTitle: 'Ready for another?',
    addTipBody: 'Tap the + button anytime to add a new session — build as many as you like.',
  ...
  settings: {
    ...
    title: 'Settings',
    watchTipTitle: 'Run it from your wrist',
    watchTipBody: 'Clear HiiT has an Apple Watch app — start and control sessions right from your wrist, synced live with your phone.',
    minimalVoiceTipTitle: 'Prefer fewer prompts?',
    minimalVoiceTipBody: "Turn on Minimal voice prompts below to skip the 'prepare' cue and just hear the interval start.",
    profile: 'Profile',
    nameLabel: 'Your name',
  ...
  onboarding: {
    ...
    whatsNew: "What's new",
    problemTitle: 'Ever lose count mid-set?',
    problemSub: "Checking your phone to see if the interval's up breaks your rhythm — and most timers go quiet the second your headphones are in.",
    solutionTitle: 'Clear HiiT calls it out loud',
    solutionSub: 'Work, rest, done — announced right over your music or podcast. No subscription, no phone-checking, just training.',
  ...
  edit: {
    ...
    inclineTipTitle: 'Treadmill incline',
    inclineTipBody: 'Set an incline percentage per interval, with presets to match your workout — look for it while editing a Run session.',
    spinning:         'Spinning',
