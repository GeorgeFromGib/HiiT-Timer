export const en = {
  ...
  onboarding: {
    ...
    sessionWorkSub: 'Work is your high-intensity push — go all-out for this long, in seconds.',
    sessionRecoverTitle: 'How long do you want to recover?',
    sessionRecoverSub: 'Recover is the rest between work intervals — ease off and catch your breath, in seconds.',
