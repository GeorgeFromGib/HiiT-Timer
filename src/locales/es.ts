...
export const es: typeof en = {
  ...
  onboarding: {
    ...
    sessionWorkSub: 'Trabajo es tu esfuerzo de alta intensidad — da el máximo durante este tiempo, en segundos.',
    sessionRecoverTitle: '¿Cuánto quieres recuperar?',
    sessionRecoverSub: 'Descanso es la pausa entre intervalos de trabajo — baja el ritmo y recupera el aliento, en segundos.',
