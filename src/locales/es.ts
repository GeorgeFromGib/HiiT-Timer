...
export const es: typeof en = {
  ...
  sessions: {
    ...
    addTipTitle: '¿Listo para otra?',
    addTipBody: 'Toca el botón + cuando quieras para añadir una nueva sesión — crea tantas como necesites.',
  ...
  onboarding: {
    ...
    sessionSetup: {
      readyTitle: '¿Listo para configurar tu primera sesión?',
