...
export const fr: typeof en = {
  ...
  folders: {
    ...
    moveSessionsTo: 'Déplacer les séances vers :',
  ...
  settings: {
    ...
    display: 'Affichage',
    hideFoldersLabel: 'Masquer les dossiers',
    hideFoldersSub: "Afficher une liste simple lorsque vous n'avez créé aucun dossier",
