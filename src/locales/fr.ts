...
export const fr: typeof en = {
  ...
  sessions: {
    ...
    addTipTitle: 'Prêt pour une autre ?',
    addTipBody: 'Appuyez sur le bouton + à tout moment pour ajouter une nouvelle séance — créez-en autant que vous voulez.',
  ...
  settings: {
    ...
    title: 'Réglages',
    watchTipTitle: 'Pilotez-le depuis votre poignet',
    watchTipBody: 'Clear HiiT propose une app Apple Watch — démarrez et contrôlez vos séances depuis votre poignet, synchronisée en direct avec votre téléphone.',
    minimalVoiceTipTitle: 'Vous préférez moins de signaux ?',
    minimalVoiceTipBody: "Activez Signaux vocaux minimalistes ci-dessous pour ignorer le signal « préparez-vous » et n'entendre que le début de l'intervalle.",
    profile: 'Profil',
    nameLabel: 'Votre nom',
  ...
  onboarding: {
    ...
    whatsNew: 'Nouveautés',
    problemTitle: 'Vous perdez le fil en plein exercice ?',
    problemSub: "Devoir regarder son téléphone pour savoir si l'intervalle est fini casse le rythme — et la plupart des minuteurs restent muets une fois le casque sur les oreilles.",
    solutionTitle: "Clear HiiT l'annonce à voix haute",
    solutionSub: "Travail, repos, terminé — annoncé par-dessus votre musique ou podcast. Sans abonnement, sans regarder votre téléphone, juste s'entraîner.",
  ...
  edit: {
    ...
    inclineTipTitle: 'Inclinaison du tapis',
    inclineTipBody: "Réglez un pourcentage d'inclinaison par intervalle, avec des préréglages adaptés à votre entraînement — disponible en modifiant une séance de Course.",
    spinning:         'Spinning',
