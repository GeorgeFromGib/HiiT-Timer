...
export const fr: typeof en = {
  ...
  onboarding: {
    ...
    sessionSetup: {
      readyTitle: 'Prêt à configurer votre première séance, %{name} ?',
  ...
  edit: {
    ...
    nameModalTitle: 'Nommez votre séance',
    nameModalContinue: 'Continuer',
    preview: 'APERÇU',
    ...
    cooldownAuto:     'AUTO',
    cooldownTaperLabel: 'Dégression du retour au calme',
    cooldownTaperHint:  "Réduit la vitesse et l'inclinaison pendant le retour au calme, à partir de la phase précédente",
