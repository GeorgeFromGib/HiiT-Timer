...
class LiveActivityModule: NSObject {
    ...
    @objc func startActivity(
        ...
        guard authInfo.areActivitiesEnabled else {
            print("[LiveActivity] activities disabled — returning early")
            resolve(nil)
            return
        }
        ...
        do {
            ...
            print("[LiveActivity] Activity.request succeeded — id: \(currentActivity?.id ?? "nil")")
            resolve(nil)
        } catch {
            print("[LiveActivity] Activity.request FAILED: \(error.localizedDescription)")
